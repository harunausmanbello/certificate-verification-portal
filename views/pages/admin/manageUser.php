                                        ...
                                        <div class="tab-content">
                                            <table class="table table-bordered mb-0 data-table fs--1">
                                                <thead class="bg-200 text-900">
                                                    <tr>
                                                        <th style="width:2%" class="sort">#</th>
                                                        <th style="width:25%" class="sort">UserName</th>
                                                        <th style="width:25%" class="sort">Role</th>
                                                                ...
                                                                <div class="col-sm-6 ">
                                                                    <form class="delUser" method="post" >
                                                                        <input type="hidden" name="userId"
                                                                            value="<?= $data['id']; ?>">
                                                                        <button type="submit" class="btn delbtn text-danger">
